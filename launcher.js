...
var ConfigParser = require('./configParser'),
    TaskScheduler = require('./lib/taskScheduler.js'),
    helper = require('./lib/util.js'),
    log = require('./lib/logger.js'),
    q = require('q'),
    TaskRunner = require('./lib/taskRunner.js');
...
var init = function(configFile, additionalConfig) {
  ...
  //log.debug('automate version: ' + require('../package.json').version);
