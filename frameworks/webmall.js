...
module.exports = {
    ...
    homelogin: function (loginobjects, acctobjects) {
        ...
        async.series([function (callback) {
            ...
            function (callback) {
               ...
               h.login(type, url, emailbox, userid, passwordbox, password, submitbutton, submitbtnlabel, paswordboxlabel, loginboxlabel);
    ...
    searchsubmit: function (searchobj) {
        ...
        prodelement = data.product.xpathprodname
        label = "First Product"


        async.series([function (cb) {
            h.clearandsendkeys(searchtype, searchbox, 'Search TextBox', searchtext);
            cb()
        }], function (err, result) {
            if (err) {
                l.errorroutine(err);
    ...
    validateproductsearch: function (type, searchtext, prodelement, label) {
        var SearchTitle = "Search results for \'" + searchtext + "\' - testing";
    ...
    addtocart: function () {
        ...
        buttontype=data.type.xpath
            BuyNowButton= data.product.addtocart
